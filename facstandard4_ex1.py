...
OUTPUT_DIR = './facstandard4_output_time'
...
FACTOR_CSV  = './facfilter3_output_time/selected_factors_2020_2023_nst.csv'  # ← 3 v2 标签
OUT_TRAIN   = f'{OUTPUT_DIR}/signals_standardized_train_2020_2023_nst.pkl'
OUT_TEST    = f'{OUTPUT_DIR}/signals_standardized_test_2024_nst.pkl'
...
def main():
    ...
    factor_labels = dict(zip(mono['factor'], mono['direction']))
